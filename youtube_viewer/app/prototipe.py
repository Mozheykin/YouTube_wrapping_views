...
class prototipe:
    def __init__(self, target_url:str, proxy:str, name_video:str) -> None:
        ...
        self.driver = webdriver.Firefox(executable_path='/home/legal/github/youtube_viewer_all/youtube_viewer/app/geckodriver', seleniumwire_options=proxy_options, options=options)
